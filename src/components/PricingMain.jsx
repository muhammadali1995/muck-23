    ...
    return (
        <div className="bg-secondary">
            <div className='py-20 lg:pt-48'>
                <h1 className="font-extrabold header-xl md:header-title text-accent text-center">Pricing</h1>
                ...
                <div className="w-100 overflow-auto lg:py-16">
                    <div className="flex mx-auto items-center max-w-[1200px] mt-[96px] justify-start lg:justify-center">
                        ...
                        <div className="bg-[#fff] text-dark-primary rounded-2xl h-[780px]  text-center">
