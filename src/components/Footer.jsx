...
export default function Footer() {
    return (
        <div className="bg-dark-primary max-w-desktop mx-auto py-8 text-white">
            <div className="flex items-center md:items-start justify-between flex-col-reverse lg:flex-row mx-auto w-8/12">
                ...
                <div className="flex items-center md:items-start text-center md:text-left justify-center sm:justify-between flex-col md:flex-row w-full md:w-7/12 flex-wrap">
                    <ul className="uppercase my-12 md:my-0">
