    ...
    return (
        <div className="max-w-desktop mx-auto my-20">
            ...
            <div className="w-full md:w-8/12 mx-auto bg-white mt-12" style={{ filter: 'drop-shadow(6px 7px 14px rgba(0, 0, 0, 0.35))', }}>
                <form>
                    <div className="flex">
                        <button className={openTab === 1 ? 'w-1/2 py-4 text-xl truncate font-medium text-dark-primary border-b-2 border-[#022F5B]' : 'w-1/2 py-4 text-xl truncate font-medium text-[#15143966] border-b-2 border-[#EBEAED]'} onClick={(e) => { e.preventDefault(); setOpenTab(1) }}>LET US CALL YOU</button>
                        <button className={openTab === 2 ? 'w-1/2 py-4 text-xl truncate font-medium text-dark-primary border-b-2 border-[#022F5B]' : 'w-1/2 py-4 text-xl truncate font-medium text-[#15143966] border-b-2 border-[#EBEAED]'} onClick={(e) => { e.preventDefault(); setOpenTab(2) }}>WRITE US A MESSAGE</button>
                    </div>
                    <div className={openTab === 1 ? 'block p-6' : 'hidden'}>
